...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("border-b border-slate-200 bg-slate-50/80 backdrop-blur", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-slate-100/90 transition-colors hover:bg-sky-50/60 data-[state=selected]:bg-sky-50",
      className
    )}
    {...props}
  />
